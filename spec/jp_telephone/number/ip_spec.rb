...
describe JpTelephone::Number::IP do
  ...
  describe '.new' do
    ...
    context '050-3300' do
      ...
      its(:company) { should == 'ＮＴＴコミュニケーショ' }
    end
    ...
    context '050-5500' do
      ...
      its(:company) { should == 'フュージョンコミュニケーショ' }
    end
    ...
    context '050-6100' do
      ...
      its(:company) { should == '日本通信株式会社' }
    end

    context '050-6619' do
      let(:number) { '05066191234' }
      its(:company) { should == '九州通信ネットワーク' }
    end
    ...
    context '050-6860' do
      ...
      its(:company) { should == 'ＺＩＰ　Ｔｅｌｅｃｏｍ' }
    end
    ...
    context '050-7770' do
      ...
      its(:company) { should == '中部テレコミュニケーショ' }
    end
    ...
    context '050-7788' do
      ...
      its(:company) { should == '東北インテリジェント通信' }
    end

    context '050-8200' do
      let(:number) { '05082001234' }
      its(:company) { should == 'エネルギア・コミュニケーションズ' }
    end
